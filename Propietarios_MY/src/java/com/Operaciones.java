...
import entity.service.AbstractFacade;
...
public class Operaciones {
    ...
    public List<BookingsObjects> objetosReservados (@PathParam("objeto")String objeto){
    ...
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Bookings> infoReserva(@PathParam("reserva") long reserva) {
        Query q;
    ...
    public List<Bookings> countReservas(@PathParam("objeto_reserva") String objeto) {
        ...
        String sql="select bo.objectno, bk.bookingno, bk.clientname, bk.datearrival, bk.datedeparture,"
                + " bk.status from Bookings bk, BookingsObjects bo"+
